...
import ButtonRow from "../buttonNumber/ButtonNumber";
...
const Home = () => {
  ...
  return (
    <>
      ...
      <div style={{display: "flex", gap: "40px", marginLeft: "35px"}}>
        <Filters />
        <div>
          <div
            style={{
          ...
          >
            <div style={{display: "flex", gap: "10px", alignItems: "center"}}>
              ...
              <h1>Add date & time to find your ideal boat for the best price</h1>
            </div>
            <div>
              <svg
                width="22"
      ...
      <div style={{backgroundColor: "#4691F21A;", width: "100%", height: "10px"}}></div>
      <div
        style={{
